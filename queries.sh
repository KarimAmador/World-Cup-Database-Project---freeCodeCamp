...
echo "$($PSQL "SELECT DISTINCT(name) FROM teams LEFT JOIN games ON games.winner_id = teams.team_id OR games.opponent_id = teams.team_id WHERE round='Eighth-Final' AND year=2014")"
